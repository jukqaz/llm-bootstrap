...
범위: 인프라 인수인계 문서/절차 요약, 실행 체크사항
비범위: 운영 기준 정리(infra-platform), 배포 런북(infra-release-runbook), 배포 체크리스트(deploy-checklist)
...
- 실행 절차는 `references/infra-execution-guide.md`를 사용하라.
...
### references/
- `handoff-template.md`: 인프라 인수인계 템플릿
- `infra-execution-guide.md`: 인프라 실행 가이드
