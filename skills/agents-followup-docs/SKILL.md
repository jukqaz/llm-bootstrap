...
- `references/decision-criteria.md`로 라이트/표준/확장 중 하나를 선택하라.
...
- `references/question-bank.md`에서 누락 정보만 질문하라.
...
### references/
- `decision-criteria.md`: 범위 선택 규칙.
- `question-bank.md`: 누락 정보 최소 질문.
