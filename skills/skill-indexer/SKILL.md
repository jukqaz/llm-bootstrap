...
범위: 스킬 인덱스 생성/갱신, 목록 정렬
비범위: 스킬 본문 수정, 스킬 설치/배포
...
- 자동화가 필요하면 `scripts/skill-indexer/Cargo.toml`을 실행하라.
...
### references/
- `skill-indexer-checklist.md`: 스킬 인덱스 체크리스트

### scripts/
- `skill-indexer/Cargo.toml`: 스킬 인덱스 생성 스크립트(Rust)
