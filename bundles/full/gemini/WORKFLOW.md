...
- Keep local task-state current with `sp internal task-state begin|advance|show`.
- Check `sp internal gate check --target-phase plan|execute|review|qa|ship --json` before moving a gated phase.
